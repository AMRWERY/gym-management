<template>
    <div class="full-screen bg-light-grey">
        <div class="login center">
            ...
            <h1 class="text-left text-2xl">{{ $t("auth.forgot_your_password") }}</h1>
            <br />
            <form>
            <div>
            ...
            <button class="btn-primary" @click="getPasswordResetLink()" type="button" id="send-password-reset-link">{{ $t('auth.send_password_reset_link') }}</button>
        <br/><br/>
      </form>
    </div>
  </div>
